...
/////////////////
const BotName = 'RIXX BOT☄'; 
const instagram = ''; 
const telegram = 'https://t.me/erikerik517'; 
const kapanbotaktif = 'YA GAK TAU KOK TANYA SAYA'; 
const youtube = 'https://youtube.com/channel/UC2rVZMIU_B2CvOI-MNOuNJw';
//const grupch1 = 'https://chat.whatsapp.com/Eh3qCDDiW41K03NIcbdTfc'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@eriksunda09')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@eriksunda09`)
})
